...
function createConfig(files, project, additionalRules = {}) {
  ...
  return {
    ...
    rules: {
      ...
      '@codygo-ai/mono/no-forbidden-imports': 'error',
      '@codygo-ai/mono/index-exports-only': 'error',
      '@codygo-ai/mono/enforce-tilde-imports': 'error',
      '@codygo-ai/mono/app-error-required-props': 'error',
      '@codygo-ai/mono/workspace-protocol': 'error',
      '@codygo-ai/mono/no-dotenv': 'error',
      '@codygo-ai/mono/require-env-example': 'error',
      '@codygo-ai/mono/package-json-schema': [
        'error',
        { requiredFields: ['name', 'version'], requiredScripts: ['lint', 'typecheck'] },
      ],
